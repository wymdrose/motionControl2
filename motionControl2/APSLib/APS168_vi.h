...
typedef struct
{
	unsigned short BitSts;	//b0: Is PTB work? [1:working, 0:Stopped]
						//b1: Is point buffer full? [1:full, 0:not full]
						//b2: Is point buffer empty? [1:empty, 0:not empty]
						//b3, b4, b5: Reserved for future
						//b6~: Be always 0
	unsigned short PntBufFreeSpace; 
	unsigned short PntBufUsageSpace;
	unsigned int RunningCnt;

} PTSTS, *PPTSTS;
//#pragma pack(push,1)
typedef struct
{
	double axisX; // x axis data for multi-dimension comparator 0
	double axisY; // y axis data for multi-dimension comparator 1
	double axisZ; // z axis data for multi-dimension comparator 2
	double axisU; // u axis data for multi-dimension comparator 3
	unsigned int chInBit; // pwm output channel in bit format; 20150609
}MCMP_POINT;
#pragma pack(pop)
...
I32 FNTYPE APS_set_trigger_point_2D( I32 Board_ID, I32 PointX, I32 PointY, I32 Tolerance, I32 Option );
//I32 FNTYPE APS_get_trigger_number_2D( I32 Board_ID, I32 *TrigNum, U16 *IsEmpty, U16 *IsFull,
//U32 *usage, U32 *free, I32 *xPos, I32 *yPos, I32 *tolerance, U32 *pwm, I32 *xEncoder, I32 *yEncoder );
I32 FNTYPE APS_get_trigger_number_2D( I32 Board_ID, I32 *TrigNum );
...
//odm function for MotionNet 4xmo
...
I32 FNTYPE APS_manual_pulser_configuration( I32 Board_ID, I32 Mode, I32 InvPA, I32 InvPB, I32 InvDir, F64 Ratio );
I32 FNTYPE APS_manual_pulser_velocity_move( I32 Axis_ID, F64 MaxVelocity );
I32 FNTYPE APS_manual_pulser_relative_move( I32 Axis_ID, F64 Distance, F64 MaxVelocity );


// Cognex ODM 20150715
I32 FNTYPE APS_COGNEX_set_point( I32 Board_ID, COGNEX_POINT *DataArr, I32 ArraySize );
I32 FNTYPE APS_COGNEX_get_point( I32 Board_ID, COGNEX_POINT *Point, I32 Index );
I32 FNTYPE APS_COGNEX_set_output_select( I32 Board_ID, I32 Mux_En, I32 Mux_C );
I32 FNTYPE APS_COGNEX_set_mux_enable( I32 Board_ID, I32 Enable );
I32 FNTYPE APS_COGNEX_get_status( I32 Board_ID, I32 *BufferCount, I32 *ActiveIndex );
I32 FNTYPE APS_COGNEX_set_do_width( I32 Board_ID, I32 Width );


// New spec pulser
I32 FNTYPE APS_PULSER_enable( I32 Board_ID, I32 OutputAxisID, F64 MaxVel, F64 MaxAcc, F64 Sfactor, I32 Enable );
I32 FNTYPE APS_PULSER_configuration( I32 Board_ID, I32 Mode, I32 InvPA, I32 InvPB, I32 InvDir, F64 Ratio );
I32 FNTYPE APS_PULSER_filter( I32 Board_ID, F64 FreqRad );
